window.addEventListener('load', function() {
    ...
    var branches = ["master", "actions-ci", "add-license", "bugfix/docsbuild", "cleanup", "delete_old_examples", "example/diak", "feature/devices_in_docker", "feature/non-root-user", "fix/remove_veth_pair_after_simulation", "gh-pages", "interface_names", "linting", "mobility_input", "new-naming-marvis", "onboarding", "qemu_branch", "readthedocs", "renaming-v2"];
