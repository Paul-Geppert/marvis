...
class DockerNode(Node):
    ...
    devices : list of str
        A list of devices. Each entry contains the path on host, the path inside the container and optional permission settings: :code:`<path>[:<path_in_container>[:<cgroup_permissions>]]`
    """
